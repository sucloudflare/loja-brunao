      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-zinc-800">
          ...
          <div className="flex gap-6">
            <a href="#" aria-label="Facebook da Luxe" className="text-zinc-400 hover:text-white transition-colors">
              <Facebook size={20} />
            </a>
            <a href="#" aria-label="Instagram da Luxe" className="text-zinc-400 hover:text-white transition-colors">
              <Instagram size={20} />
            </a>
            <a href="#" aria-label="Twitter da Luxe" className="text-zinc-400 hover:text-white transition-colors">
              <Twitter size={20} />
            </a>
          </div>
        </div>
